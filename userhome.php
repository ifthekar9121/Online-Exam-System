...
<html>
    ...
    <body class="bgimg">
        ...
        <li><a class="w3-text-blue" href="#"><?php echo $_SESSION['name'];?></a></li>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) 
            {
        echo "<tr align=center><td>".$row["id"]."</td><td>".$row["title"]."</td><th>
                <input class='w3-radio' type='radio' name='take' value='".$row["title"]."'>
