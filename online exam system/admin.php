...
<?php 
    if(isset($_POST['submit'])){
		...
		if (empty($_POST['user_mail']) || empty($_POST['password1'])){
			...
			$errorMassage='fild is empty! ';
                ...
                {   $user_mail=$_POST['user_mail'];
      			...
      			$sql = " SELECT COUNT(*) FROM admin WHERE( email='".$user_mail."' AND pass='".$pass."') ";
     ...
     <body class="img mar3">
         ...
         <form class="w3-container w3-card-4 w3-half" action="" method="post">
             <img src="./image/admin.jpg" width="15%" class="mar2">
                <p>      
                <label class="w3-text-brown" ><b>User E-mail</b></label>
                <input class="w3-input w3-border" name="user_mail" type="text" required></p>
                <p>      
