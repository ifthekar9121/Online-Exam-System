...
if(isset($_POST['submit'])){
        ...
        {            
			...
			$sql = "INSERT INTO question (title,ans1,ans2,ans3,ans4,true_ans,difficulty,course_id)
				VALUES ('".$qd."','".$o1."','".$o2."','".$o3."','".$o4."','".$ta."','".$diff."','".$ca."')";

				if (mysqli_query($conn, $sql)) {
					echo "<script type='text/javascript'>alert('New Question added successfully')</script>";
...
<html>
    ...
    // output data of each row
                ...
                echo "<tr align=center class='w3-text-blue'><td>".$row["id"]."</td><th>
                <input class='w3-radio' type='radio' name='ca' value='".$row["id"]."'>
